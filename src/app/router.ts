  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'finance/debtors', name: 'finance-debtors', component: () => import('../views/errors/ComingSoonPage.vue') },
        { path: 'finance/nadplaty', name: 'finance-nadplaty', component: () => import('../views/errors/ComingSoonPage.vue') },
        { path: 'finance/settings-ustawienia', name: 'finance-ustawienia', component: () => import('../views/finance/settings/SettingsIndex.vue') },
        { path: 'accounting/faktury', name: 'accounting-faktury', component: () => import('../views/errors/ComingSoonPage.vue') },
