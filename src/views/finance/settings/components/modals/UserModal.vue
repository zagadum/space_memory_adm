...
.mpj {
  padding: 8px 12px; font-size: 11.5px; font-weight: 700; color: #8892b0;
  background: rgba(255,255,255,0.03); border: 1px solid rgba(100,120,255,0.12);
  border-radius: 10px; cursor: pointer; transition: all .2s;
}
.mpj.sel { background: rgba(16, 185, 129, 0.08); border-color: rgba(16, 185, 129, 0.3); color: #10b981; }

.trow { display: flex; align-items: center; justify-content: space-between; padding: 14px 0; border-top: 1px solid rgba(255,255,255,0.06); }
