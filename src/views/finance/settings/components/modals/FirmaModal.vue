...
.modal {
  ...
  border-radius: 16px; width: 90%; max-width: 580px; max-height: 90vh; overflow-y: auto;
}
...
.gr2 { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 12px; }
