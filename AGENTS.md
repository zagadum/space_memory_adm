...
2. **Form Request** — `app/Http/Requests/V1/StoreXxxRequest.php`
3. **API Resource** — `app/Http/Resources/V1/XxxResource.php`
4. **Controller** — `app/Http/Controllers/Api/V1/XxxController.php`
5. **Route** — `routes/api.php` с префиксом `v1` + `auth:sanctum`
